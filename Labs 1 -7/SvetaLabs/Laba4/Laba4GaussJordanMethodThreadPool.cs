...
namespace SvetaLabs.Laba4
{
    public class Laba4GaussJordanMethodThreadPool
    {
        ...
        public Laba4GaussJordanMethodThreadPool()
        {
        ...
        public void StartWithMultiTreading()
        {
            ...
            for (int k = 0; k < _size; k++)
            {
                ThreadPool.QueueUserWorkItem((state) => CountingMatrix(_matrixCoef, _freeCoef, k));
            ...
            {
                ThreadPool.QueueUserWorkItem((state) => GetResult(_matrixCoef, _freeCoef, _result, k));
